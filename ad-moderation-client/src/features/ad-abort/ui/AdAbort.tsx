      ...
      >
        <Form form={form} layout="vertical">
          ...
          <Form.Item name="comment" label="Комментарий">
            ...
            />
            {/* todo: по всей видимости, комментарий должен появляться только тогда, когда выбирается причина
                "Другое". отправляться соответственно Другое тоже должно только при этой причине*/}
          </Form.Item>
        </Form>
      </Modal>
    </>
