...
- действия с объявлениями: одобрение, отклонение, отправка на доработку, возможность выбора нескольких объявлений для массовых действий и оставление комментариев
- отображение статистики по своей работе в виде графиков и таблиц с выбором периода статистики
